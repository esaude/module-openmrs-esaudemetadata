...
public class MetadataBundleUtils {

    public static class _Privilege {
        //public static final String VIEW_POC = "View poc details jsut test";
        //public static final String ADMIN_POC = "Administer poc just testing";
    }

    public static class _Role {
        //public static final String POC = "Application: poc just testing";
